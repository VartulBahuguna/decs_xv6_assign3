  ...
  13:	83 39 02             	cmpl   $0x2,(%ecx)
{
  ...
  1b:	51                   	push   %ecx
  1c:	ff 33                	push   (%ebx)
  1e:	68 12 08 00 00       	push   $0x812
  23:	6a 01                	push   $0x1
  25:	e8 b6 04 00 00       	call   4e0 <printf>
        exit();
  2a:	e8 34 03 00 00       	call   363 <exit>
    }
  ...
  36:	e8 68 03 00 00       	call   3a3 <open>
    if (fd < 0) {
  ...
  47:	50                   	push   %eax
  48:	e8 23 00 00 00       	call   70 <ping_pong>
    close(fd);
  4d:	89 34 24             	mov    %esi,(%esp)
  50:	e8 36 03 00 00       	call   38b <close>

    exit();
  55:	e8 09 03 00 00       	call   363 <exit>
        printf(1, "Error opening file %s\n", argv[1]);
  5a:	50                   	push   %eax
  5b:	ff 73 04             	push   0x4(%ebx)
  5e:	68 2a 08 00 00       	push   $0x82a
  63:	6a 01                	push   $0x1
  65:	e8 76 04 00 00       	call   4e0 <printf>
        exit();
  6a:	e8 f4 02 00 00       	call   363 <exit>
  6f:	90                   	nop
  ...
  74:	31 ff                	xor    %edi,%edi
{
  76:	56                   	push   %esi
  77:	53                   	push   %ebx
  78:	8d 5d 83             	lea    -0x7d(%ebp),%ebx
  7b:	83 ec 7c             	sub    $0x7c,%esp
  ...
  8d:	53                   	push   %ebx
  8e:	56                   	push   %esi
  8f:	e8 e7 02 00 00       	call   37b <read>
  94:	83 c4 10             	add    $0x10,%esp
  97:	85 c0                	test   %eax,%eax
  99:	7e 4d                	jle    e8 <ping_pong+0x78>
        if((ch[0] >= 'a' && ch[0] <='z') || (ch[0] >= 'A' && ch[0] <='Z') || (ch[0] >= '0' && ch[0] <='9')){
  9b:	0f b6 4d 83          	movzbl -0x7d(%ebp),%ecx
  9f:	89 c8                	mov    %ecx,%eax
  a1:	83 e0 df             	and    $0xffffffdf,%eax
  a4:	83 e8 41             	sub    $0x41,%eax
  a7:	3c 19                	cmp    $0x19,%al
  a9:	76 07                	jbe    b2 <ping_pong+0x42>
  ab:	8d 41 d0             	lea    -0x30(%ecx),%eax
  ae:	3c 09                	cmp    $0x9,%al
  b0:	77 0e                	ja     c0 <ping_pong+0x50>
            word[i++] = ch[0];
  b2:	88 4c 3d 84          	mov    %cl,-0x7c(%ebp,%edi,1)
  b6:	83 c7 01             	add    $0x1,%edi
  b9:	eb cd                	jmp    88 <ping_pong+0x18>
  bb:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  bf:	90                   	nop
            if(strcmp(word, "ping") == 0){
  c0:	83 ec 08             	sub    $0x8,%esp
  c3:	8d 45 84             	lea    -0x7c(%ebp),%eax
            word[i++] = '\0';
  c6:	c6 44 3d 84 00       	movb   $0x0,-0x7c(%ebp,%edi,1)
            if(strcmp(word, "ping") == 0){
  cb:	68 08 08 00 00       	push   $0x808
  d0:	50                   	push   %eax
  d1:	e8 6a 00 00 00       	call   140 <strcmp>
  d6:	83 c4 10             	add    $0x10,%esp
  d9:	89 c7                	mov    %eax,%edi
  db:	85 c0                	test   %eax,%eax
  dd:	74 11                	je     f0 <ping_pong+0x80>
            i=0;
  df:	31 ff                	xor    %edi,%edi
  e1:	eb a5                	jmp    88 <ping_pong+0x18>
  ...
  f3:	68 0d 08 00 00       	push   $0x80d
  f8:	68 3d 08 00 00       	push   $0x83d
  fd:	6a 01                	push   $0x1
  ff:	e8 dc 03 00 00       	call   4e0 <printf>
 104:	83 c4 10             	add    $0x10,%esp
 107:	e9 7c ff ff ff       	jmp    88 <ping_pong+0x18>
 ...
 4e9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 667:	90                   	nop
          s = "(null)";
 668:	ba 41 08 00 00       	mov    $0x841,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 681:	a1 80 0b 00 00       	mov    0xb80,%eax
{
 ...
 6c1:	5b                   	pop    %ebx
  freep = p;
 6c2:	89 15 80 0b 00 00    	mov    %edx,0xb80
}
 6c8:	5e                   	pop    %esi
 6c9:	5f                   	pop    %edi
 6ca:	5d                   	pop    %ebp
 ...
 6f9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 6fc:	89 15 80 0b 00 00    	mov    %edx,0xb80
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 719:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 71c:	8b 3d 80 0b 00 00    	mov    0xb80,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 75f:	73 4f                	jae    7b0 <malloc+0xa0>
    ...
    if(p == freep)
 761:	8b 3d 80 0b 00 00    	mov    0xb80,%edi
 ...
 78a:	e8 f1 fe ff ff       	call   680 <free>
  return freep;
 78f:	8b 15 80 0b 00 00    	mov    0xb80,%edx
 ...
 7bc:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 7bf:	89 15 80 0b 00 00    	mov    %edx,0xb80
}
 ...
 7cf:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 7d0:	c7 05 80 0b 00 00 84 	movl   $0xb84,0xb80
 7d7:	0b 00 00 
    base.s.size = 0;
 7da:	bf 84 0b 00 00       	mov    $0xb84,%edi
    base.s.ptr = freep = prevp = &base;
 7df:	c7 05 84 0b 00 00 84 	movl   $0xb84,0xb84
 7e6:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7e9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 7eb:	c7 05 88 0b 00 00 00 	movl   $0x0,0xb88
 7f2:	00 00 00 
    if(p->s.size >= nunits){
