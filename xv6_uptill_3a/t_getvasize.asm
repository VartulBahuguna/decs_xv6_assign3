...
int main(int argc, char *argv[])
{
  ...
  50:	50                   	push   %eax
  51:	68 d8 07 00 00       	push   $0x7d8
  56:	6a 01                	push   $0x1
  58:	e8 13 04 00 00       	call   470 <printf>
  ...
  7b:	50                   	push   %eax
  7c:	68 b4 07 00 00       	push   $0x7b4
  81:	6a 01                	push   $0x1
  83:	e8 e8 03 00 00       	call   470 <printf>
  printf(1, "Address returned by sbrk: x0%x\n", sbrk_after);
  88:	83 c4 0c             	add    $0xc,%esp
  8b:	53                   	push   %ebx
  8c:	68 f8 07 00 00       	push   $0x7f8
  91:	6a 01                	push   $0x1
  93:	e8 d8 03 00 00       	call   470 <printf>
 ...
 479:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 4e9:	ff 24 85 20 08 00 00 	jmp    *0x820(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 5f7:	90                   	nop
          s = "(null)";
 5f8:	ba 18 08 00 00       	mov    $0x818,%edx
        while(*s != 0){
 ...
 611:	a1 24 0b 00 00       	mov    0xb24,%eax
{
 ...
 689:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 68c:	89 15 24 0b 00 00    	mov    %edx,0xb24
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6a9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6ac:	8b 3d 24 0b 00 00    	mov    0xb24,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6ef:	73 4f                	jae    740 <malloc+0xa0>
    ...
    if(p == freep)
 6f1:	8b 3d 24 0b 00 00    	mov    0xb24,%edi
 ...
 71a:	e8 f1 fe ff ff       	call   610 <free>
  return freep;
 71f:	8b 15 24 0b 00 00    	mov    0xb24,%edx
 ...
 767:	0b 00 00 
    base.s.size = 0;
 76a:	bf 28 0b 00 00       	mov    $0xb28,%edi
    base.s.ptr = freep = prevp = &base;
 ...
 779:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 77b:	c7 05 2c 0b 00 00 00 	movl   $0x0,0xb2c
 782:	00 00 00 
    if(p->s.size >= nunits){
