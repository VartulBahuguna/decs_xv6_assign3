...

{
  ...
  21:	ff 77 04             	push   0x4(%edi)
  24:	e8 87 01 00 00       	call   1b0 <strlen>
    char command[size];
  29:	83 c4 10             	add    $0x10,%esp
  2c:	83 c0 10             	add    $0x10,%eax
  ...
  51:	51                   	push   %ecx
  52:	ff 37                	push   (%edi)
  54:	68 18 08 00 00       	push   $0x818
  59:	6a 01                	push   $0x1
  5b:	e8 90 04 00 00       	call   4f0 <printf>
        exit();
  60:	e8 0e 03 00 00       	call   373 <exit>
    char command[size];
  65:	81 e2 ff 0f 00 00    	and    $0xfff,%edx
  6b:	29 d4                	sub    %edx,%esp
  6d:	85 d2                	test   %edx,%edx
  6f:	74 05                	je     76 <main+0x76>
  71:	83 4c 14 fc 00       	orl    $0x0,-0x4(%esp,%edx,1)
  76:	89 e6                	mov    %esp,%esi
    strcpy(command,argv[1]);
  78:	52                   	push   %edx
  79:	52                   	push   %edx
  7a:	ff 77 04             	push   0x4(%edi)
  7d:	56                   	push   %esi
  7e:	e8 9d 00 00 00       	call   120 <strcpy>
    char* param[argc];
  83:	8d 04 9d 00 00 00 00 	lea    0x0(,%ebx,4),%eax
  8a:	8d 4b ff             	lea    -0x1(%ebx),%ecx
  8d:	89 f3                	mov    %esi,%ebx
  8f:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  92:	83 c0 0f             	add    $0xf,%eax
  95:	89 f4                	mov    %esi,%esp
  97:	89 c2                	mov    %eax,%edx
  99:	25 00 f0 ff ff       	and    $0xfffff000,%eax
  9e:	83 e2 f0             	and    $0xfffffff0,%edx
  a1:	29 c3                	sub    %eax,%ebx
  a3:	39 dc                	cmp    %ebx,%esp
  a5:	74 10                	je     b7 <main+0xb7>
  a7:	81 ec 00 10 00 00    	sub    $0x1000,%esp
  ad:	83 8c 24 fc 0f 00 00 	orl    $0x0,0xffc(%esp)
  b4:	00 
  b5:	eb ec                	jmp    a3 <main+0xa3>
  b7:	81 e2 ff 0f 00 00    	and    $0xfff,%edx
  bd:	29 d4                	sub    %edx,%esp
  bf:	85 d2                	test   %edx,%edx
  c1:	75 47                	jne    10a <main+0x10a>
  c3:	8d 47 04             	lea    0x4(%edi),%eax
  c6:	03 7d e4             	add    -0x1c(%ebp),%edi
  c9:	89 4d e4             	mov    %ecx,-0x1c(%ebp)
  cc:	89 e3                	mov    %esp,%ebx
    for(int i = 0; i<argc-1; ++i){
  ce:	89 da                	mov    %ebx,%edx
        param[i] = argv[i+1];
  d0:	8b 08                	mov    (%eax),%ecx
    for(int i = 0; i<argc-1; ++i){
  d2:	83 c0 04             	add    $0x4,%eax
  d5:	83 c2 04             	add    $0x4,%edx
        param[i] = argv[i+1];
  d8:	89 4a fc             	mov    %ecx,-0x4(%edx)
    for(int i = 0; i<argc-1; ++i){
  db:	39 f8                	cmp    %edi,%eax
  dd:	75 f1                	jne    d0 <main+0xd0>
    }
    param[argc-1] = 0;
  df:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
  e2:	c7 04 8b 00 00 00 00 	movl   $0x0,(%ebx,%ecx,4)
    
    int pid = fork();
  e9:	e8 7d 02 00 00       	call   36b <fork>
    if(pid == 0){
  ...
  f4:	53                   	push   %ebx
  f5:	56                   	push   %esi
  f6:	e8 b0 02 00 00       	call   3ab <exec>
  ...
  fe:	e8 70 02 00 00       	call   373 <exit>
        wait();
 103:	e8 73 02 00 00       	call   37b <wait>
 108:	eb f4                	jmp    fe <main+0xfe>
    char* param[argc];
 10a:	83 4c 14 fc 00       	orl    $0x0,-0x4(%esp,%edx,1)
 10f:	eb b2                	jmp    c3 <main+0xc3>
 ...
 4f9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 677:	90                   	nop
          s = "(null)";
 678:	ba 3c 08 00 00       	mov    $0x83c,%edx
        while(*s != 0){
 ...
 691:	a1 50 0b 00 00       	mov    0xb50,%eax
{
 ...
 6d1:	5b                   	pop    %ebx
  freep = p;
 6d2:	89 15 50 0b 00 00    	mov    %edx,0xb50
}
 6d8:	5e                   	pop    %esi
 6d9:	5f                   	pop    %edi
 6da:	5d                   	pop    %ebp
 ...
 709:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 70c:	89 15 50 0b 00 00    	mov    %edx,0xb50
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 729:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 72c:	8b 3d 50 0b 00 00    	mov    0xb50,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 76f:	73 4f                	jae    7c0 <malloc+0xa0>
    ...
    if(p == freep)
 771:	8b 3d 50 0b 00 00    	mov    0xb50,%edi
 ...
 79a:	e8 f1 fe ff ff       	call   690 <free>
  return freep;
 79f:	8b 15 50 0b 00 00    	mov    0xb50,%edx
 ...
 7cc:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 7cf:	89 15 50 0b 00 00    	mov    %edx,0xb50
}
 ...
 7e7:	0b 00 00 
    base.s.size = 0;
 7ea:	bf 54 0b 00 00       	mov    $0xb54,%edi
    base.s.ptr = freep = prevp = &base;
 7ef:	c7 05 54 0b 00 00 54 	movl   $0xb54,0xb54
 7f6:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7f9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 7fb:	c7 05 58 0b 00 00 00 	movl   $0x0,0xb58
 802:	00 00 00 
    if(p->s.size >= nunits){
