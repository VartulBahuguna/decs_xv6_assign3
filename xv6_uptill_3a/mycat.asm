...
int main(){
   ...
   e:	53                   	push   %ebx
   f:	51                   	push   %ecx
  10:	81 ec fc 03 00 00    	sub    $0x3fc,%esp
    int pid = fork();
  16:	e8 a0 02 00 00       	call   2bb <fork>
    if(pid == 0){
  1b:	85 c0                	test   %eax,%eax
  1d:	75 48                	jne    67 <main+0x67>
  1f:	8d b5 00 fc ff ff    	lea    -0x400(%ebp),%esi
  ...
  32:	6a 01                	push   $0x1
  34:	e8 aa 02 00 00       	call   2e3 <write>
            int r = read(0, buff, sizeof(buff));
  39:	83 c4 0c             	add    $0xc,%esp
  3c:	68 e8 03 00 00       	push   $0x3e8
  41:	56                   	push   %esi
  42:	6a 00                	push   $0x0
  44:	e8 92 02 00 00       	call   2db <read>
  ...
  53:	56                   	push   %esi
  54:	6a 01                	push   $0x1
  56:	e8 88 02 00 00       	call   2e3 <write>
            if(r == 0) break;
  5b:	83 c4 10             	add    $0x10,%esp
  5e:	85 db                	test   %ebx,%ebx
  60:	75 c6                	jne    28 <main+0x28>
        }
    }else{
        wait();
    }
  ...
  62:	e8 5c 02 00 00       	call   2c3 <exit>
        wait();
  67:	e8 5f 02 00 00       	call   2cb <wait>
  6c:	eb f4                	jmp    62 <main+0x62>
  6e:	66 90                	xchg   %ax,%ax
 ...
 449:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 4b9:	ff 24 85 74 07 00 00 	jmp    *0x774(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 5c7:	90                   	nop
          s = "(null)";
 5c8:	ba 6d 07 00 00       	mov    $0x76d,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 5e1:	a1 7c 0a 00 00       	mov    0xa7c,%eax
{
 ...
 621:	5b                   	pop    %ebx
  freep = p;
 622:	89 15 7c 0a 00 00    	mov    %edx,0xa7c
}
 628:	5e                   	pop    %esi
 629:	5f                   	pop    %edi
 62a:	5d                   	pop    %ebp
 ...
 659:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 65c:	89 15 7c 0a 00 00    	mov    %edx,0xa7c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 679:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 67c:	8b 3d 7c 0a 00 00    	mov    0xa7c,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6bf:	73 4f                	jae    710 <malloc+0xa0>
    ...
    if(p == freep)
 6c1:	8b 3d 7c 0a 00 00    	mov    0xa7c,%edi
 ...
 6ea:	e8 f1 fe ff ff       	call   5e0 <free>
  return freep;
 6ef:	8b 15 7c 0a 00 00    	mov    0xa7c,%edx
 ...
 71c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 71f:	89 15 7c 0a 00 00    	mov    %edx,0xa7c
}
 ...
 72f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 730:	c7 05 7c 0a 00 00 80 	movl   $0xa80,0xa7c
 737:	0a 00 00 
    base.s.size = 0;
 73a:	bf 80 0a 00 00       	mov    $0xa80,%edi
    base.s.ptr = freep = prevp = &base;
 73f:	c7 05 80 0a 00 00 80 	movl   $0xa80,0xa80
 746:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
