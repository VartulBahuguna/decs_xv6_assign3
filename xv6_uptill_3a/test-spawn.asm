...
_test-spawn:     file format elf32-i386
  ...
  14:	83 39 01             	cmpl   $0x1,(%ecx)
{
  ...
  60:	6a 01                	push   $0x1
  62:	e8 a9 04 00 00       	call   510 <printf>
        exit();
  ...
  a8:	e8 ee 02 00 00       	call   39b <wait>
            printf(1, "reaped process with id %d \n", cpid);
  ad:	83 ec 04             	sub    $0x4,%esp
        for (int i = 0; i < num_child; i++)
  b0:	83 c3 01             	add    $0x1,%ebx
            printf(1, "reaped process with id %d \n", cpid);
  b3:	50                   	push   %eax
  b4:	68 80 08 00 00       	push   $0x880
  b9:	6a 01                	push   $0x1
  bb:	e8 50 04 00 00       	call   510 <printf>
        for (int i = 0; i < num_child; i++)
  ...
  c8:	31 db                	xor    %ebx,%ebx
        printf(1,"Child PID list:\n");
  ca:	52                   	push   %edx
  cb:	68 9c 08 00 00       	push   $0x89c
  d0:	6a 01                	push   $0x1
  d2:	e8 39 04 00 00       	call   510 <printf>
  ...
  e6:	83 c3 01             	add    $0x1,%ebx
            printf(1, "%d ", pids[i]);
  e9:	68 ad 08 00 00       	push   $0x8ad
  ee:	6a 01                	push   $0x1
  f0:	e8 1b 04 00 00       	call   510 <printf>
        for (int i = 0; i < num_child; i++)
 ...
 10f:	53                   	push   %ebx
 110:	53                   	push   %ebx
 111:	68 5c 08 00 00       	push   $0x85c
 116:	6a 01                	push   $0x1
 118:	e8 f3 03 00 00       	call   510 <printf>
        exit();
 11d:	e8 71 02 00 00       	call   393 <exit>
        printf(1,"Spawned child pid %d\n", getpid());
 122:	e8 ec 02 00 00       	call   413 <getpid>
 127:	51                   	push   %ecx
 128:	50                   	push   %eax
 129:	68 6a 08 00 00       	push   $0x86a
 12e:	6a 01                	push   $0x1
 ...
 46c:	89 d1                	mov    %edx,%ecx
{
 ...
 499:	0f b6 92 10 09 00 00 	movzbl 0x910(%edx),%edx
 ...
 519:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 589:	ff 24 85 b8 08 00 00 	jmp    *0x8b8(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 697:	90                   	nop
          s = "(null)";
 698:	ba b1 08 00 00       	mov    $0x8b1,%edx
        while(*s != 0){
 ...
 6b1:	a1 c4 0b 00 00       	mov    0xbc4,%eax
{
 ...
 6f1:	5b                   	pop    %ebx
  freep = p;
 6f2:	89 15 c4 0b 00 00    	mov    %edx,0xbc4
}
 6f8:	5e                   	pop    %esi
 6f9:	5f                   	pop    %edi
 6fa:	5d                   	pop    %ebp
 ...
 729:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 72c:	89 15 c4 0b 00 00    	mov    %edx,0xbc4
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 749:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 74c:	8b 3d c4 0b 00 00    	mov    0xbc4,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 78f:	73 4f                	jae    7e0 <malloc+0xa0>
    ...
    if(p == freep)
 791:	8b 3d c4 0b 00 00    	mov    0xbc4,%edi
 ...
 7ba:	e8 f1 fe ff ff       	call   6b0 <free>
  return freep;
 7bf:	8b 15 c4 0b 00 00    	mov    0xbc4,%edx
 ...
 7ec:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 7ef:	89 15 c4 0b 00 00    	mov    %edx,0xbc4
}
 ...
 807:	0b 00 00 
    base.s.size = 0;
 80a:	bf c8 0b 00 00       	mov    $0xbc8,%edi
    base.s.ptr = freep = prevp = &base;
 80f:	c7 05 c8 0b 00 00 c8 	movl   $0xbc8,0xbc8
 816:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 819:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 81b:	c7 05 cc 0b 00 00 00 	movl   $0x0,0xbcc
 822:	00 00 00 
    if(p->s.size >= nunits){
